...
class CryptoPayAPI:
    ...
    def create_invoice(self, asset, amount, description=None, hidden_message=None, paid_btn_name=None, paid_btn_url=None, payload=None, allow_comments=True, allow_anonymous=True, expires_in=None):
        params = {
            "asset": asset,
            "amount": amount,
...
class AsyncCryptoPayAPI:
    ...
    async def _request(self, method, params=None):
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(self.base_url + method, headers=headers, params=params) as response:
                response.raise_for_status()
    ...
    async def create_invoice(self, asset, amount, description=None, hidden_message=None, paid_btn_name=None, paid_btn_url=None, payload=None, allow_comments=True, allow_anonymous=True, expires_in=None):
        params = {
            "asset": asset,
            "amount": amount,
            "description": description,
    ...
    async def transfer(self, user_id, asset, amount, spend_id, comment=None, disable_send_notification=False):
        params = {
            "user_id": user_id,
            "asset": asset,
            "amount": amount,
    ...
    async def get_invoices(self, asset=None, invoice_ids=None, status=None, offset=0, count=100):
        params = {
            "asset": asset,
            "invoice_ids": invoice_ids,
            "status": status,
